...
const serializeAws_restJson1CreateGeofenceCollectionCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/geofencing/v0/collections";
    let body;
    body = JSON.stringify({
...
const serializeAws_restJson1CreateMapCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/maps/v0/maps";
    let body;
    body = JSON.stringify({
...
const serializeAws_restJson1CreatePlaceIndexCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/places/v0/indexes";
    let body;
    body = JSON.stringify({
...
const serializeAws_restJson1CreateRouteCalculatorCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/routes/v0/calculators";
    let body;
    body = JSON.stringify({
...
const serializeAws_restJson1CreateTrackerCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/tracking/v0/trackers";
    let body;
    body = JSON.stringify({
        ...(input.Description !== undefined && input.Description !== null && { Description: input.Description }),
        ...(input.KmsKeyId !== undefined && input.KmsKeyId !== null && { KmsKeyId: input.KmsKeyId }),
...
const serializeAws_restJson1ListGeofenceCollectionsCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/geofencing/v0/list-collections";
    let body;
    body = JSON.stringify({
        ...(input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults }),
        ...(input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken }),
...
const serializeAws_restJson1ListMapsCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/maps/v0/list-maps";
    let body;
    body = JSON.stringify({
        ...(input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults }),
        ...(input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken }),
...
const serializeAws_restJson1ListPlaceIndexesCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/places/v0/list-indexes";
    let body;
    body = JSON.stringify({
        ...(input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults }),
        ...(input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken }),
...
const serializeAws_restJson1ListRouteCalculatorsCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/routes/v0/list-calculators";
    let body;
    body = JSON.stringify({
        ...(input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults }),
        ...(input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken }),
...
const serializeAws_restJson1ListTrackersCommand = async (input, context) => {
    ...
    let resolvedPath = `${(basePath === null || basePath === void 0 ? void 0 : basePath.endsWith("/")) ? basePath.slice(0, -1) : basePath || ""}` + "/tracking/v0/list-trackers";
    let body;
    body = JSON.stringify({
        ...(input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults }),
        ...(input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken }),
...
const deserializeAws_restJson1BoundingBox = (output, context) => {
    return (output || [])
        ...
        return smithy_client_1.handleFloat(entry);
    });
};
const deserializeAws_restJson1CalculateRouteSummary = (output, context) => {
    return {
        ...
        Distance: smithy_client_1.handleFloat(output.Distance),
        DistanceUnit: smithy_client_1.expectString(output.DistanceUnit),
        DurationSeconds: smithy_client_1.handleFloat(output.DurationSeconds),
...
const deserializeAws_restJson1SearchPlaceIndexForPositionSummary = (output, context) => {
    return {
        DataSource: smithy_client_1.expectString(output.DataSource),
        MaxResults: smithy_client_1.expectNumber(output.MaxResults),
        Position: output.Position !== undefined && output.Position !== null
            ? deserializeAws_restJson1Position(output.Position, context)
            : undefined,
    };
...
const deserializeAws_restJson1Step = (output, context) => {
    return {
        ...
        EndPosition: output.EndPosition !== undefined && output.EndPosition !== null
            ? deserializeAws_restJson1Position(output.EndPosition, context)
            : undefined,
        GeometryOffset: smithy_client_1.expectNumber(output.GeometryOffset),
        StartPosition: output.StartPosition !== undefined && output.StartPosition !== null
            ? deserializeAws_restJson1Position(output.StartPosition, context)
            : undefined,
    };
